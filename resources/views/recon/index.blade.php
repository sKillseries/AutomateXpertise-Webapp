<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight dark:text-white">
            {{ __("Reconnaissance - Information Gathering") }}
        </h2>
    </x-slot>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex">
                <div class="max-w-xl">
                    <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Execute Recon Scripts</h2>
                    <br>
                    <form method="post" action="{{ url('/execute-recon') }}" class="mt-6 space-y-6">
                        @csrf
                        <div>
                        ...
                        <br>
                        <div>
                            <label for="cible_argument_1" class="mt-4 text-m leading-relaxed dark:text-white">Masque réseaux (CIDR) e.g /24 <i class="fas fa-info-circle" title="Nécessaire que pour adrecon"></i> :</label>
                            <x-text-input class="mt-1 block w-full" type="text" name="cible_argument_1" id="cible_argument_1" />
                            <p class="dark:text-white">Ne pas mettre le "/" mettez juste la valeur CIDR</p>
                        </div>
                        <div>
                            <label for="cible_argument_2" class="mt-4 text-m leading-relaxed dark:text-white">Range <i class="fas fa-info-circle" title="Nécessaire que pour adrecon"></i> :</label>
                            <x-text-input class="mt-1 block w-full" type="text" name="cible_argument_2" id="cible_argument_2" />
                            <p class="dark:text-white">Format plage IP1-IPn ou IP réseaux/CIDR</p>
                        </div>
                        <br>
